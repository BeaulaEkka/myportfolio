...
const LandingPage = () => {
  ...
  const pages =
    typeof window !== "undefined" && window.innerWidth < 1400 ? 11 : 4.8;
  ...
  return (
    <Parallax pages={pages} ref={ref} className={styles.parallaxContainer}>
      ...
      <ParallaxLayer offset={0} speed={0} style={{ zIndex: -1 }}>
        <div className={styles.landingpage_herotext}>
          ...
          <p className={styles.landingpage_herotext_p}>
            I&apos;m a Full Stack Developer, a Graphic Designer and a UX/UI
            Designer
          </p>
        </div>
      </ParallaxLayer>
      ...
      <ParallaxLayer
        offset={
          typeof window !== "undefined" && window.innerWidth < 1400 ? 5.5 : 2.5
        }
        speed={1}
        style={{ zIndex: "999" }}
